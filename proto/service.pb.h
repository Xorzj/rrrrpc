...
PROTOBUF_NAMESPACE_OPEN
template<> ::example::AddRequest* Arena::CreateMaybeMessage<::example::AddRequest>(Arena*);
template<> ::example::AddResponse* Arena::CreateMaybeMessage<::example::AddResponse>(Arena*);
...
class AddRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:example.AddRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:example.AddRequest)
 private:
  class _Internal;
...
class AddResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:example.AddResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:example.AddResponse)
 private:
  class _Internal;
...
inline int32_t AddRequest::a() const {
  // @@protoc_insertion_point(field_get:example.AddRequest.a)
  return _internal_a();
}
...
inline void AddRequest::set_a(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:example.AddRequest.a)
}
...
inline int32_t AddRequest::b() const {
  // @@protoc_insertion_point(field_get:example.AddRequest.b)
  return _internal_b();
}
...
inline void AddRequest::set_b(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:example.AddRequest.b)
}
...
inline int32_t AddResponse::result() const {
  // @@protoc_insertion_point(field_get:example.AddResponse.result)
...
inline void AddResponse::set_result(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:example.AddResponse.result)
}
